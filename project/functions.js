var functions_d6ad677b_427a_4623_b50f_a445a3b0ef8a = 
{
	...
	if (core.flags.statusBarItems.indexOf('enableMoney') >= 0)
		hint += ',' + core.getStatusLabel('money') + '+' + Math.ceil(core.getFlag('zczy')); // hint += "，金币+" + money;
	if (core.flags.statusBarItems.indexOf('enableExp') >= 0)
		hint += ',剩余' + core.getStatusLabel('exp') + exp; // hint += "，经验+" + exp;
	...
	*/
	...
	if (!core.domStyle.isVertical) {
		...
		if (core.hasItem('pack')) {
			...
			_fillBoldTextWithFontCheck(('反物质'), 88, 48, '#98FB98');
			_fillBoldTextWithFontCheck(core.itemCount('I848'), 34, 94, '#FFCCAA');
			_fillBoldTextWithFontCheck(('星系'), 88, 94, '#E0FFFF');
		} else {
			_fillBoldTextWithFontCheck(core.formatBigNumber(core.getRealStatus('money')), 34, 48, "#F0E68C");
			_fillBoldTextWithFontCheck(('反物质'), 88, 48, '#98FB98');
